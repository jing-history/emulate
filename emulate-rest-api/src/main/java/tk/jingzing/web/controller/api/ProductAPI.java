package tk.jingzing.web.controller.api;
...
import tk.jingzing.core.entity.ArcResponse;
import tk.jingzing.web.model.Product;
import tk.jingzing.web.service.ProductService;
...
public class ProductAPI {
    ...
    public ArcResponse<Product> modifyProduct(@PathVariable("id")String id,@RequestBody Product product){
        product.setId(id);
